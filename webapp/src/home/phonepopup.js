...
export const CartPopup = ({close, next}) => (
    <>
            ...
            <Body>
                It is probably time for an upgrade. Today's consumer value reduced effort, reduced time, quality, and organization <a href="https://hbr.org/2016/08/the-30-things-customers-really-value" target='_blank'>according to Harvard Business Review</a>.
